...
namespace Burrows.Tests.RabbitMq
{
	...
	public class When_converting_a_type_to_a_message_name
	{
		...
		public void Should_handle_an_interface_name()
		{
			...
			name.ToString().ShouldEqual("Burrows.Tests.RabbitMq:NameEasyToo");
		}
		...
		public void Should_handle_nested_classes()
		{
			...
			name.ToString().ShouldEqual("Burrows.Tests.RabbitMq:When_converting_a_type_to_a_message_name-Nested");
		}
		...
		public void Should_handle_regular_classes()
		{
			...
			name.ToString().ShouldEqual("Burrows.Tests.RabbitMq:NameEasy");
		}
		...
		public void Should_handle_a_closed_single_generic()
		{
			...
			name.ToString().ShouldEqual("Burrows.Tests.RabbitMq:NameGeneric--System:String--");
		}
		...
		public void Should_handle_a_closed_double_generic()
		{
            ...
            name.ToString().ShouldEqual("Burrows.Tests.RabbitMq:NameDoubleGeneric--System:String::NameEasy--");
		}
		...
		public void Should_handle_a_closed_double_generic_with_a_generic()
		{
			...
			name.ToString().ShouldEqual("Burrows.Tests.RabbitMq:NameDoubleGeneric--NameGeneric--NameEasyToo--::NameEasy--");
		}
